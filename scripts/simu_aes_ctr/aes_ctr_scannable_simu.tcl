...
set_property  ip_repo_paths  {/home/nasm/Projects/fpga_ip/ip/aes_ctr/aes_ctr_scannable_1.0 /home/nasm/Projects/fpga_scan_ip/ip_repo/fast_ip_scanner_1.0} [current_project]
update_ip_catalog
startgroup
create_bd_cell -type ip -vlnv user.org:user:fast_ip_scanner:1.0 fast_ip_scanner_0
endgroup
startgroup
create_bd_cell -type ip -vlnv user.org:user:aes_ctr_scannable:1.0 aes_ctr_0
endgroup
set_property location {1 65 -104} [get_bd_cells aes_ctr_0]
set_property location {1 142 -109} [get_bd_cells aes_ctr_0]
startgroup
make_bd_pins_external  [get_bd_pins aes_ctr_0/s00_axi_aresetn] [get_bd_pins aes_ctr_0/s00_axi_aclk]
endgroup
...
connect_bd_intf_net [get_bd_intf_pins axi_vip_1/M_AXI] [get_bd_intf_pins aes_ctr_0/S00_AXI]
connect_bd_net [get_bd_pins aes_ctr_0/scan_input] [get_bd_pins fast_ip_scanner_0/scan_input]
connect_bd_net [get_bd_pins aes_ctr_0/scan_enable] [get_bd_pins fast_ip_scanner_0/scan_enable]
connect_bd_net [get_bd_pins aes_ctr_0/scan_ck_en] [get_bd_pins fast_ip_scanner_0/scan_ck_en]
connect_bd_net [get_bd_pins aes_ctr_0/scan_output] [get_bd_pins fast_ip_scanner_0/scan_output]
save_bd_design
copy_bd_objs /  [get_bd_cells {axi_vip_0}]
...
assign_bd_address [get_bd_addr_segs {aes_ctr_0/S00_AXI/S00_AXI_reg }]
open_bd_design {/home/nasm/Projects/fpga_ip/aes_ctr_scannable_simu/aes_ctr_scannable_simu.srcs/sources_1/bd/design_1/design_1.bd}
...
set_property offset 0x44C00000 [get_bd_addr_segs {axi_vip_1/Master_AXI/SEG_aes_ctr_0_S00_AXI_reg}]
save_bd_design


set_property SOURCE_SET sources_1 [get_filesets sim_1]
add_files -fileset sim_1 -norecurse /home/nasm/Projects/fpga_ip/scripts/simu_aes_ctr/tb_axi_slv_scannable_aes_ctr.sv
...
set_property top tb_axi_slv_aes_ctr [get_filesets sim_1]
set_property top_lib xil_defaultlib [get_filesets sim_1]
update_compile_order -fileset sim_1

add_files -fileset sim_1 -norecurse /home/nasm/Projects/fpga_ip/scripts/simu_aes_ctr/tb_axi_slv_scannable_aes_ctr_behav.wcfg
set_property xsim.view /home/nasm/Projects/fpga_ip/scripts/simu_aes_ctr/tb_axi_slv_scannable_aes_ctr_behav.wcfg [get_filesets sim_1]

launch_simulation
#source tb_axi_slv_aes_ctr.tcl
